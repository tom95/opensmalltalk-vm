/* Automatically generated by
   ...
   from
	ThreadedARMFFIPlugin VMMaker.oscogSPC-eem.2112 uuid: 2cb05138-53ee-44f4-9ef2-687f081b72d6
 */
static char __buildInfo[] = "ThreadedARMFFIPlugin VMMaker.oscogSPC-eem.2112 uuid: 2cb05138-53ee-44f4-9ef2-687f081b72d6 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ARM32FFIPlugin VMMaker.oscogSPC-eem.2112 (i)"
#else
	"ARM32FFIPlugin VMMaker.oscogSPC-eem.2112 (e)"
#endif
;
 ...
 */
	...
	/* ThreadedARMFFIPlugin>>#ffiCalloutTo:SpecOnStack:in: */
static sqInt
...
ffiLogCallsTo(char*fileName)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushDoubleFloat:in: */
static sqInt
...
#    endif /* COGMTVM */
	...
	/* ThreadedARMFFIPlugin>>#ffiPushPointer:in: */
static sqInt
ffiPushPointerin(void *pointer, CalloutState *calloutState)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushSignedByte:in: */
static sqInt
ffiPushSignedBytein(sqInt value, CalloutState *calloutState)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushSignedChar:in: */
static sqInt
ffiPushSignedCharin(sqInt value, CalloutState *calloutState)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushSignedInt:in: */
static sqInt
...
ffiPushSignedLongLongOopin(sqInt oop, CalloutState *calloutState)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushSignedLongLong:in: */
static sqInt
ffiPushSignedLongLongin(sqLong value, CalloutState *calloutState)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushSignedShort:in: */
static sqInt
ffiPushSignedShortin(sqInt value, CalloutState *calloutState)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushSingleFloat:in: */
static sqInt
...
#      endif /* COGMTVM */
	...
	/* ThreadedARMFFIPlugin>>#ffiPushStructure:ofSize:typeSpec:ofLength:in: */
static sqInt
ffiPushStructureofSizetypeSpecofLengthin(void *pointer, sqInt structSize, sqInt *argSpec, sqInt argSpecSize, CalloutState *calloutState)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushUnsignedByte:in: */
static sqInt
ffiPushUnsignedBytein(sqInt value, CalloutState *calloutState)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushUnsignedChar:in: */
static sqInt
ffiPushUnsignedCharin(sqInt value, CalloutState *calloutState)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushUnsignedInt:in: */
static sqInt
...
ffiPushUnsignedLongLongOopin(sqInt oop, CalloutState *calloutState)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushUnsignedLongLong:in: */
static sqInt
ffiPushUnsignedLongLongin(usqLong value, CalloutState *calloutState)
{
	...
	/* ThreadedARMFFIPlugin>>#ffiPushUnsignedShort:in: */
static sqInt
...
/*	Create a structure return value from an external function call. The value
	...
	/* ThreadedARMFFIPlugin>>#ffiReturnStruct:ofType:in: */
static sqInt
...
/*	Answer if a struct result of a given size is returned in memory or not. */
	...
	/* ThreadedARMFFIPlugin>>#returnStructInRegisters: */
static sqInt
