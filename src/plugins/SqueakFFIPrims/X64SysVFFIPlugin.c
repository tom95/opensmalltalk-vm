/* Automatically generated by
   ...
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscogSPC-eem.2112 uuid: 2cb05138-53ee-44f4-9ef2-687f081b72d6
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscogSPC-eem.2112 uuid: 2cb05138-53ee-44f4-9ef2-687f081b72d6 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64SysVFFIPlugin VMMaker.oscogSPC-eem.2112 (i)"
#else
	"X64SysVFFIPlugin VMMaker.oscogSPC-eem.2112 (e)"
#endif
;
				 ...
				 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters) <= NumIntRegArgs)) {
					...
					if (structSize > 8) {
						if (passField1InXmmReg) {
							/* begin ffiPushDoubleFloat:in: */
							value1 = (((double *) ptrAddress))[1];
							if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
								((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = value1;
								(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
							}
							else {
								if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
								...
								storeFloatAtPointerfrom((calloutState->currentArg), value1);
								(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
							}
					...
					if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters1) <= NumFloatRegArgs)
					 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters1) <= NumIntRegArgs)) {
						if (passField0InXmmReg1) {
							/* begin ffiPushDoubleFloat:in: */
							value2 = (((double *) ptrAddress))[0];
							if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
								((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = value2;
								(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
							}
							else {
								if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
								...
								storeFloatAtPointerfrom((calloutState->currentArg), value2);
								(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
							}
						...
						if (structSize1 > 8) {
							if (passField1InXmmReg1) {
								/* begin ffiPushDoubleFloat:in: */
								value11 = (((double *) ptrAddress))[1];
								if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
									((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = value11;
									(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
								}
								else {
									if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
									...
									storeFloatAtPointerfrom((calloutState->currentArg), value11);
									(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
								}
